/** Full ID3v1 genre list: 80 original + Winamp extensions = 192 total. */
export const ID3_GENRES: string[] = [
  // 0-79: Original ID3v1 genres
  ...
  "World Music", "Neoclassical", "Audiobook", "Audio Theatre", "Neue Deutsche Welle",
